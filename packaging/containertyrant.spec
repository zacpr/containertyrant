...
Recommends:    docker or moby-engine
...
install -Dpm0755 target/release/containertyrant %{buildroot}%{_libexecdir}/containertyrant

# Install the wrapper script
install -Dpm0755 packaging/bin/containertyrant %{buildroot}%{_bindir}/containertyrant
...
%changelog
* Sat Mar 08 2026 Zac <zac@ashurtech.net> - 0.1.0-2
- Fix graphics compatibility with software renderer fallback
